...
<html xmlns:th="http://www.thymeleaf.org" lang="en">
  ...
  <body class="container">
    ...
    <form action="<c:url value='/auth/login'/>" method="post" modelAttribute="user" class="col-lg-8">
      ...
      <button type="submit" class="btn btn-primary w-100 py-2 my-3">登入</button>
	  <a href="<c:url value='/auth/register'/>">前往註冊</a>
	</form>
